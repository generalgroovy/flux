...
| 3 | Five-slot spell grammar | Complete foundation: protocol 23 carries stable `spell_1`…`spell_5` edges and snapshot schema 7 replicates the host-owned order; the in-world Loom safely repositions the two proven kit spells while honest empties refuse. Next promote beam/spray/field/movement-defense fixtures one at a time. |
