...
func _test_repository_recipes() -> void:
	...
	equal(presenter.atlas_hash, "237d751b446571787516d8e83fa04f7ec3cbd982fb2d41dc5bcbf6a84fa73090", "elevated three-champion eight-way action atlas hash is pinned")
