...
export function validateOverhaulContent() {
  ...
  if (CHARACTER_ROSTER.length !== 15) errors.push("exactly fifteen future characters are required");
  const requiredCharacterNames = ["Oh Tipi", "S. Wayne", "The Red Baron", "Steezo", "Treevor the Mason", "Oll' I", "Fluup", "Wa Bidi", "Nico Lai", "Spai Si", "Hidn Leef", "Ha Rekt", "Dr. Apex", "Hara", "Hesus Christo"];
