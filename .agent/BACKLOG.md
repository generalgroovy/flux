...
| 3 | Five-slot spell grammar | Complete foundation: protocol 24 carries stable `spell_1`…`spell_5` edges, snapshot schema 8 replicates host-owned order and beam cues, and the Loom safely repositions the two proven kit spells. Pocket Eclipse is the first cover-stopped beam; promote spray/field/defense/movement fixtures one at a time. |
