...
| 4 | Interactive Wellspring stations (seven live) | Guide, Bell, Loom, Charter, Hearth and diegetic Host/Join Farflow gates have fixed-point focus, F/controller interaction and transparent bubbles; remaining settings and travel remain |
...
| 12 | First bounded arena round (playable foundation complete) | Hearth start moves the intact roster into an authored court; individual combat teams, wards, sealed bounds, score/time limit, knockout/respawn, result and synchronized return pass 60/120 Hz two-process journeys; pre-round presentation and explicit rematch remain |
| 13 | Host stewardship | The host can explicitly confirm kick/close actions in-world, every affected traveller receives a readable reason, and moderation cannot be forged or triggered accidentally |
| 14 | Court readability and rematch | The three-second transition names the rules/spawns, result state freezes clearly, and all connected travellers can ready for a second round without reopening Farflow |
