...
| 2 | **Whole-scene visual cohesion — active (D0–D3 and D5 green; D4 partial)** | The shared `S/SE/E/NE/N/NW/W/SW` contract is deterministic from normalized input through prediction, replay, ENet and capture. Reviewed diagonal grounded/cast/hit/walk/sprint cells, travel-versus-aim gait and safe evasion cues are live; one fail-closed delivery contract now aligns hands, startup, release, projectile art and cast recovery while beam/spray aim stays continuous. Next verify Wellspring corners, cover, doors, elevation, cutaways and receiving shadows; promote diagonal evasion body art only after reviewed sources exist. |
