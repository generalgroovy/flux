...
| 2 | **Whole-scene visual cohesion — active** | Preserve the green four-cardinal body baseline, then expand movement and facing to `S/SE/E/NE/N/NW/W/SW`: continuous/normalized simulation vectors remain authoritative while a shared resolver drives diagonal bodies, forward/back/strafe gait, advanced-movement aliases, hand delivery, effects and capture evidence; then complete source-court assets, shadows/bubbles and the four-cell HUD without changing rules. |
