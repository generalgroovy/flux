...
| 2 | **Whole-scene visual cohesion — active** | Enforce exactly `small`/`middle`/`large`; promote body-and-clothing-only symmetric foundation atlases with bounded 0.90×/1.00×/1.10× render scales while composing hands/effects, projectiles, environment, shadows/elevation, bubbles and four-cell HUD as separate reusable layers; verify 50/75/100% standard/high-contrast/reduced modes. |
