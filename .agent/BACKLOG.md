...
| 3 | **Three viable body roles + Red Baron — complete in source** | Small skirmisher, middle adapter and large anchor share collision and universal movement on equal budget; Red Baron is selectable with eight-way body/clothing art, Cinderbolt/Rimewake, 60/120 combat tests and truthful runtime capture. Exact-commit packaging remains part of the next checkpoint. |
| 4 | **Readable bullet-pattern pressure — active next** | A deterministic five-shot fan (`-24,-12,0,+12,+24`) preserves ordered IDs, collision, packet/work budgets, ownership, and clean evasion lanes at 60/120 Hz; every universal movement option remains legal under pressure. |
| 5 | **Eight elemental bursts** | Fire, Water, Earth, Wind, Charge, Ice, Light, and Dark each provide a positive-Flux configurable burst through the global 3×4 Spell Loom; element changes presentation/chemistry identity, never hidden fan geometry or automatic damage advantage. |
