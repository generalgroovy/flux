...
| ---: | --- | --- |
| P0-P5 | Original three-quarter top-down virtual-pixel foundation, Living Sanctum terrain/elevation, Nico sprite, Charge/Light spells, text/HUD, integrated acceptance | P0-P2 accepted; P3 implementation complete with hands-on held-input acceptance pending |
