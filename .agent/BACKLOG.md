...
| 6 | Friend-play vertical slice (transport/handshake live) | Next: register two authoritative actors, host-consume input, publish/interpolate snapshots, interaction/emote, leave/reconnect and Windows/Linux direct-IP smoke |
