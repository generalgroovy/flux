...
| 2 | **Whole-scene visual cohesion — active (D0–D3 green; D4 next)** | The shared `S/SE/E/NE/N/NW/W/SW` contract is deterministic from normalized input through prediction, replay, ENet and capture; both champions now have reviewed diagonal grounded/cast/hit/walk/sprint cells, travel-versus-aim facing, and explicit gait cues while jump/slide/roll fail closed to cardinal art. Next add diagonal advanced-action aliases before spell delivery, environment alignment and final acceptance. |
