...
| ---: | --- | --- |
| 1 | `.agent/PIXEL-PERSPECTIVE-OVERHAUL.md` P0-P5: original three-quarter top-down pixel perspective across characters, Sanctum/maps, spells/elements, text, and interface | P0 accepted; P1 Living Sanctum presentation active |
