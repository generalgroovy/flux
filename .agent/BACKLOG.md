...
| 2 | **Whole-scene visual cohesion — active (D0–D2 green; D3 next)** | The shared `S/SE/E/NE/N/NW/W/SW` contract is deterministic from normalized keyboard/controller input through prediction, replay, ENet and capture; both champions now have reviewed diagonal grounded/cast/hit cells while unpromoted states fail closed to cardinal art. Next add diagonal locomotion and relative gait before advanced movement, spell delivery, environment alignment and final acceptance. |
