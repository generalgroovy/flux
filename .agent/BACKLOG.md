...
| 4 | Interactive Wellspring stations (six live) | Guide, Bell, Loom, Charter and diegetic Host/Join Farflow gates have fixed-point focus, F/controller interaction and transparent bubbles; remaining settings and travel remain |
...
| 11 | Session Hearth roster and readiness | A walk-up host station shows connected/returning travellers, lets each traveller visibly ready/unready, allows host kick only with explicit confirmation, and gates a shared practice start without a detached menu |
