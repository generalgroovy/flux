...
| 15 | Late-join spectator | A guest joining an active court stays non-participating, cycles replicated participant focus without leaking hidden state, sees the next-gathering rule and automatically returns to Hearth play |
