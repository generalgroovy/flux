...
| 2 | **Whole-scene visual cohesion — active (D0–D3 and D5–D6 green; D4 partial; D7 next)** | Eight-way movement/presentation and spell delivery are deterministic; Wellspring collision corners, exterior thresholds, low cover, warm cutaways and material/elevation-aware receiving shadows now align without renderer-owned rules. Next capture both champions across representative movement, evasion and spells at 50/75/100%, accessibility modes and a real Farflow pair; promote diagonal evasion body art only after reviewed sources exist. |
