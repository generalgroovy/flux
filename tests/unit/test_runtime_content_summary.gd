...
func run() -> int:
	...
	equal(SummaryScript.spell_loom_lines(summary), ["16 SPELLS / 12 POSITIONS", "5 PLAYABLE CHAMPIONS", "36 RECIPES / CHEMISTRY SEALED"], "compact player copy is honest and derived")
