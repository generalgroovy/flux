...
| D7 — evidence complete / polish open | The non-overwriting 19-cell runner covers both champions, eight directions/action states, 50/75/100% zoom, all accessibility review profiles, 720p/1080p and a real mixed-champion Farflow pair; it emits a manifest and contact sheet. | Deterministic/source/package gates pass, but the reviewed rubric mean is 4.29/5 against the required 4.5. Raise material identity and action/spell response, then rerun the exact matrix before opening mechanics. |
