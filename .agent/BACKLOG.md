...
| 6 | Friend-play vertical slice (shared movement live) | Stable host/guest actors, host-stamped input, 60 Hz snapshots, named sprites and Windows localhost smoke pass; next: projectile replication, authorized station/emote requests, reconciliation, reconnect and Linux direct-IP smoke |
