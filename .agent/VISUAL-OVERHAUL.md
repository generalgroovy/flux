...
| ---: | --- | --- |
| 1 | `.agent/PIXEL-PERSPECTIVE-OVERHAUL.md` P0-P5: original three-quarter top-down pixel perspective across characters, Sanctum/maps, spells/elements, text, and interface | P0-P1 accepted; P2 Nico runtime sprite active |
