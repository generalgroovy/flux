...
| 2 | **Whole-scene visual cohesion — active** | Enforce exactly `small`/`middle`/`large`; the deterministic two-sheet-per-champion body pipeline now supplies dedicated grounded/jump/cast/hit/walk/sprint/slide/roll art in south/east/north/west on one pivot, with multi-zoom/high-contrast/reduced evidence; close defense/interaction/emote/defeat/control aliases, then continue centrally registered five-phase spell delivery, source-court assets, separate effects/projectiles/shadows/bubbles and the four-cell HUD without changing rules. |
