...
| 2 | **Whole-scene visual cohesion — active (D0 green; D1 next)** | The shared `S/SE/E/NE/N/NW/W/SW` resolver is deterministic and capture-addressable while continuous simulation and the green four-cardinal body fallback remain authoritative; next prove normalized keyboard, continuous controller, prediction, replay and Farflow parity in every sector before diagonal art, relative gait, advanced movement, spell delivery, environment alignment and final acceptance. |
