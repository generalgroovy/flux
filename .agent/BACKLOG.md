...
| 2 | Comfortable in-game controls | Implemented: schema 5 and the walk-up lectern capture keyboard/mouse-button/wheel/controller inputs, swap conflicts, unbind/reset/cancel, save immediately and suppress local play safely while open; package smoke is repeated at the next release checkpoint. |
