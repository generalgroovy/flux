...
| 10 | Diegetic session settings | Host chooses bounded lobby name, 2–8 capacity, friendly interaction policy and practice reset rules at a Wellspring station; rules are hashed in compatibility, visible before join and host-authoritative |
