...
| 9 | Cross-platform friend build | Windows and Garuda packages from one commit pass doctor, launch, direct-IP move/emote/leave/reconnect and clear UDP firewall/forwarding guidance without hidden services |
