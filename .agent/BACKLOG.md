...
| 2 | **Whole-scene visual cohesion — active (D0–D3 green; D4 partial)** | The shared `S/SE/E/NE/N/NW/W/SW` contract is deterministic from normalized input through prediction, replay, ENet and capture; both champions now have reviewed diagonal grounded/cast/hit/walk/sprint cells, travel-versus-aim facing, relative gait cues, and a validated directional evasion cue while jump/slide/roll remain explicit nearest-cardinal body fallback. Next promote reviewed diagonal evasion art, then align spell delivery and environment surfaces. |
