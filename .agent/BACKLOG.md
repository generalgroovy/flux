...
| 2 | **Whole-scene visual cohesion — active (D0–D1 green; D2 next)** | The shared `S/SE/E/NE/N/NW/W/SW` contract is deterministic from normalized keyboard/controller input through equal radial acceleration, prediction, replay, ENet and capture while the green four-cardinal body fallback remains explicit; next add reviewed diagonal grounded/cast/hit body cells for both champions before relative gait, advanced movement, spell delivery, environment alignment and final acceptance. |
