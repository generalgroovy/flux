...
| 2 | **Whole-scene visual cohesion — active** | Enforce exactly `small`/`middle`/`large`; promote body-and-clothing-only symmetric foundation atlases with bounded 0.90×/1.00×/1.10× render scales, data-driven `atlas_row` assignment, centrally registered five-phase delivery skeletons, six bounded source-court lantern/planter/rune accents, and separate hands/effects, projectiles, environment, shadows/elevation, bubbles and four-cell HUD layers; verify 50/75/100% standard/high-contrast/reduced modes. |
