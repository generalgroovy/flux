...
| 4 | Interactive Wellspring stations (guide/reset/champion live) | Fixed-point focus, F/controller interaction and transparent bubbles cover Movement Guide, Practice Bell and Champion Loom; settings, host and join remain without a detached main menu |
| 5 | First two complete champions (Oh Tipi basic pair live) | Both identities/stats/sprites are canonical; Oh Tipi's Rillshot/Tideline and resettable effigy pass 60/120 Hz, while S. Wayne's distinct pair and both champions' deeper dummy/accessibility acceptance remain |
